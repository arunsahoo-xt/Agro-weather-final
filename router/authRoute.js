...
const { registerUser ,loginUser,editUser,deletePoly,addNote,getUser} = require('../controller/userControllers.js');
...
router.route("/:id/:addnote").put(addNote);
router.route("/:id").patch(deletePoly);
